...
export const translations = {
  ...
  ko: {
    ...
    approveDepositConfirm: "{user}의 입금 요청을 승인하시겠습니까?",
    rejectDepositPrompt: "{user}의 입금 요청 거절 사유:",
    depositApprovedToast: "승인되었습니다. 유저에게 JOY를 전송하세요.",
    depositRejectedToast: "입금 요청이 거절되었습니다.",
    ...
    exchangeRateChanged: "JOY 환율 업데이트: 1 USDT = {joy} JOY / 1 JOY = {krw} KRW",
